...
BUILD_DIR="${CURRENT_DIR}/rpmbuild"
...
cp -r "${CURRENT_DIR}/build/dist" "${BUILD_DIR}/SOURCES" || exit 1
echo  "${CURRENT_DIR}/build/dist successfully copied to ${BUILD_DIR}/SOURCES"
